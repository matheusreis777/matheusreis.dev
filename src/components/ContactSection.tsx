  ...
  return (
    <section id="contato" className="min-h-screen flex flex-col justify-center section-glow py-24 mb-12">
      <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10 w-full">
        <div
          ref={headerRef}
          className={`mb-16 max-w-2xl mx-auto text-center transition-opacity duration-700 ${headerVisible ? "animate-fade-up" : "opacity-0"}`}
        >
        ...
        <div ref={cardsRef} className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          <a href="tel:+5567991431860" className={`flex flex-col items-center text-center p-8 bg-card/20 border border-border/40 rounded-3xl backdrop-blur-sm transition-colors duration-300 hover:bg-card/40 hover:border-primary/30 hover:-translate-y-2 hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] group ${cardsVisible ? "animate-fade-up stagger-1" : "opacity-0"}`}>
          ...
          <a href="mailto:matheusreismendonca1@gmail.com" className={`flex flex-col items-center text-center p-8 bg-card/20 border border-border/40 rounded-3xl backdrop-blur-sm transition-colors duration-300 hover:bg-card/40 hover:border-primary/30 hover:-translate-y-2 hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] group ${cardsVisible ? "animate-fade-up stagger-2" : "opacity-0"}`}>
            <div className="w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center mb-6 transition-transform duration-300 group-hover:scale-110 group-hover:bg-primary/20">
